...
const NewsletterAdmin = () => {
  ...
  const deleteNewsletter = async (id) => {
    try {
      ...
      setError('Failed to delete newsletters. Please try again.');
    }
  };
      ...
      <div class="card-body">
        <div class="table-responsive">
          <Table striped bordered hover>
            ...
            <tbody>
              {newsletters.map((newsletterItem, index) => (
                <tr key={newsletterItem.id}>
                  <td>{index + 1}</td>
                  <td>{newsletterItem.email}</td>
                  <td>
                    <Button
                      variant="danger"
                      onClick={() => deleteNewsletter(newsletterItem.id)}
                    >
                      Delete
                    </Button>
                  </td>
